...
function listWork (work) {
    ...
    for(let i =0;i<work.length;i++) {
      ...
      <span class="inline-block mx-1 px-4 my-7 text-lg font-black  rounded-[26px] text-white bg-[#FF7C7C] ">${works.date}</span>
        <span class="inline-block mx-1 px-4 my-7 text-xl font-normal  rounded-[26px] text-[#21243D] ">${works.short_description}</span>
